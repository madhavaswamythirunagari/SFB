		...
		int totnumst=0;
			...
			try
			{
				...
				stmt=conn.createStatement();	
				  ...
				  String Sq="SELECT FNAME,SUBJECT, avg(g1) AS gd1,avg(g2) AS gd2,avg(g3) AS gd3, avg(g4) AS gd4, avg(g5) AS gd5, avg(g6) AS gd6, avg(g7) AS gd7, avg(g8) AS gd8, avg(g9) AS gd9, avg(g10) AS gd10, count(*) AS numst ,avg([TOT-PER]) AS per FROM SUB_DET where class='"+t_class+"'  and year='"+t_year+"' GROUP BY fname, subject";
